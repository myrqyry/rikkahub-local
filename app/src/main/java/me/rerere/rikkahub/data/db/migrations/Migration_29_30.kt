...
object Migration_29_30 : Migration(29, 30) {
    override fun migrate(db: SupportSQLiteDatabase) {
        ...
        db.execSQL("CREATE INDEX IF NOT EXISTS `index_agent_run_events_run_id_sequence` ON `agent_run_events` (`run_id`, `sequence`)")
        ...
        db.execSQL("ALTER TABLE `conversation_entity` ADD COLUMN `revision` INTEGER NOT NULL DEFAULT 0")
    }
}
