...
- **Correction superseded:** User clarified that Local Dream was intentionally removed because the prior implementation/license was unacceptable, and said the project created its own replacement. Do not restore the legacy Local Dream settings entry or treat the old Local Dream page/resources as a feature to preserve without verifying the current replacement and license context.
