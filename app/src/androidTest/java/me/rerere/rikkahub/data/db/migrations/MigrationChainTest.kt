 ...
 * version (31) through the exact production chain. Each start version seeds representative
...
class MigrationChainTest {
    ...
    @Test
    fun migrate27To31_preservesSeededRowsAndSchema() = migrateChainFrom(27)

    @Test
    fun migrate28To31_preservesSeededRowsAndSchema() = migrateChainFrom(28)

    @Test
    fun migrate29To31_preservesSeededRowsAndSchema() = migrateChainFrom(29)

    @Test
    fun migrate30To31_preservesSeededRowsAndSchema() = migrateChainFrom(30)

    private fun migrateChainFrom(startVersion: Int) {
        val testDb = "migration-chain-$startVersion-to-31"
        ...
        val db = helper.runMigrationsAndValidate(testDb, 31, true, *chainFrom(startVersion))
