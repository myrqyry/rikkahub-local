...
interface EvidenceStore {
    fun put(record: EvidenceRecord): EvidenceWriteResult

    fun get(id: String): EvidenceRecord?

    fun query(query: EvidenceQuery = EvidenceQuery()): List<EvidenceRecord>
}
...
class InMemoryEvidenceStore : EvidenceStore {
    ...
    override fun get(id: String): EvidenceRecord? = records[id]

    override fun query(query: EvidenceQuery): List<EvidenceRecord> = records.values.filter { record ->
