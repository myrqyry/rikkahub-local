...
import me.rerere.rikkahub.data.agentrun.RoomContinuationStore
...
val dataSourceModule = module {
    ...
    single {
        ...
        Room.databaseBuilder(context, AppDatabase::class.java, "rikka_hub")
            ...
            .addMigrations(Migration_6_7, Migration_11_12, Migration_13_14, Migration_14_15, Migration_15_16, Migration_23_24, Migration_27_28, Migration_28_29, Migration_29_30, Migration_30_31, Migration_31_32, Migration_32_33, Migration_33_34)
    ...
    // Zero procedure persistence + executor (roadmap B3/B5). ProcedureCache seam implemented
    ...
    single { get<AppDatabase>().continuationCheckpointDao() }
    single<ContinuationStore> { RoomContinuationStore(get()) }
