...
class UnifiedModelsViewModelTest {
    ...
    private fun viewModelWith(
        ...
        registry = FakeRegistry(models, assignments),
    ...
    private class FakeRegistry(
        ...
        override val providers = MutableStateFlow(
            listOf(ModelProviderDescriptor("provider", "Provider", enabled = true, modelIds = models.map { it.id }))
        )
    ...
    private class FakeLegacy(title: String? = null, translation: String? = null) : LegacyModelAssignmentAdapter {
        ...
        override suspend fun setTranslationModel(modelId: String?) { translationModelId.value = modelId }
    }
}
